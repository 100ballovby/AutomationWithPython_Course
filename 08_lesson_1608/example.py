data = {'AED': 'United Arab Emirates Dirham', 'AFN': 'Afghan Afghani', 'ALL': 'Albanian Lek', 'AMD': 'Armenian Dram',
        'ANG': 'Netherlands Antillean Gulden', 'AOA': 'Angolan Kwanza', 'ARS': 'Argentine Peso',
        ...
        'BTN': 'Bhutanese Ngultrum', 'BWP': 'Botswana Pula', 'BYN': 'Belarusian Ruble', 'BYR': 'Belarusian Ruble',
        'BZD': 'Belize Dollar', 'CAD': 'Canadian Dollar', 'CDF': 'Congolese Franc', 'CHF': 'Swiss Franc',
        'CLF': 'Unidad de Fomento', 'CLP': 'Chilean Peso', 'CNH': 'Chinese Renminbi Yuan Offshore',
        'CNY': 'Chinese Renminbi Yuan', 'COP': 'Colombian Peso', 'CRC': 'Costa Rican Colón',
        'CUC': 'Cuban Convertible Peso', 'CVE': 'Cape Verdean Escudo', 'CZK': 'Czech Koruna', 'DJF': 'Djiboutian Franc',
        ...
        'FKP': 'Falkland Pound', 'GBP': 'British Pound', 'GBX': 'British Penny', 'GEL': 'Georgian Lari',
        'GGP': 'Guernsey Pound', 'GHS': 'Ghanaian Cedi', 'GIP': 'Gibraltar Pound', 'GMD': 'Gambian Dalasi',
        'GNF': 'Guinean Franc', 'GTQ': 'Guatemalan Quetzal', 'GYD': 'Guyanese Dollar', 'HKD': 'Hong Kong Dollar',
        'HNL': 'Honduran Lempira', 'HRK': 'Croatian Kuna', 'HTG': 'Haitian Gourde', 'HUF': 'Hungarian Forint',
        'IDR': 'Indonesian Rupiah', 'ILS': 'Israeli New Sheqel', 'IMP': 'Isle of Man Pound', 'INR': 'Indian Rupee',
        'IQD': 'Iraqi Dinar', 'ISK': 'Icelandic Króna', 'JEP': 'Jersey Pound', 'JMD': 'Jamaican Dollar',
        ...
        'MMK': 'Myanmar Kyat', 'MNT': 'Mongolian Tögrög', 'MOP': 'Macanese Pataca', 'MRO': 'Mauritanian Ouguiya',
        'MTL': 'Maltese Lira', 'MUR': 'Mauritian Rupee', 'MVR': 'Maldivian Rufiyaa', 'MWK': 'Malawian Kwacha',
        ...
        'SCR': 'Seychellois Rupee', 'SEK': 'Swedish Krona', 'SGD': 'Singapore Dollar', 'SHP': 'Saint Helenian Pound',
        'SLL': 'Sierra Leonean Leone', 'SOS': 'Somali Shilling', 'SRD': 'Surinamese Dollar',
        'SSP': 'South Sudanese Pound', 'STD': 'São Tomé and Príncipe Dobra', 'SVC': 'Salvadoran Colón',
        'SZL': 'Swazi Lilangeni', 'THB': 'Thai Baht', 'TJS': 'Tajikistani Somoni', 'TMM': 'Turkmenistani Manat',
        ...
        'UZS': 'Uzbekistan Som', 'VES': 'Venezuelan Bolívar Soberano', 'VND': 'Vietnamese Đồng', 'VUV': 'Vanuatu Vatu',
        'WST': 'Samoan Tala', 'XAF': 'Central African Cfa Franc', 'XAG': 'Silver (Troy Ounce)',
        'XAU': 'Gold (Troy Ounce)', 'XCD': 'East Caribbean Dollar', 'XDR': 'Special Drawing Rights',
        'XOF': 'West African Cfa Franc', 'XPD': 'Palladium', 'XPF': 'Cfp Franc', 'XPT': 'Platinum',
